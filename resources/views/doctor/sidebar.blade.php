...
<nav>
    ...
    <div class="sidebar-links">
        <ul>
            ...
            ?>" data-tooltip="0">
                <a href="{{ route('doctor_index') }}" data-active="0">
                    <div class="icons">
            ...
            <button class="dropdown-btn ">
                <div class="icons">
                    ...
                    <span class="text-1">Appointment Time</span>
                </div>
            ...
            <div class="dropdown-container">
                <ul>
                    ...
                    ?>"><a
                            href="{{ route('doctor.create.appointment') }}">Create</a></li>
                    <li class="drop_li <?php
                    if ($currentPage == 'department_view') {
                        echo 'active';
                    }
                    ?>"><a href="{{ route('doctor.index.appointment') }}">Check</a></li>
                </ul>
            </div>
            <button class="dropdown-btn">
                <div class="icons">
                    <img src="{{ asset('assets/admin/src/assets/img/users-svgrepo-com.svg') }}" />
                    <span class="text-1">Patients</span>
                </div>
                <i class="fa fa-angle-down" aria-hidden="true"></i>
            </button>
            <div class="dropdown-container">
                <ul>
                    ...
                    ?>"><a
                            href="{{ route('doctor.patient.today') }}">Appointments(Today)</a></li>
                    <li class="drop_li <?php
                    if ($currentPage == 'doctor_view') {
                        echo 'active';
                    }
                    ?>"><a href="{{ route('doctor.patient.all') }}">All Appointments</a></li>
                </ul>
            </div>
        </ul>
    </div>
