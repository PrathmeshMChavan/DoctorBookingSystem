                            ...
                            <table id="zero-config" class="table dt-table-hover" style="width:100%">
                                ...
                                <tbody class="text-center">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{ date('g:i a', strtotime($appointment->appointment->time)) }}</th>
                                        <td>{{ $appointment->appointment->doctor->full_name }}</td>
                                        <td>
                                            <button><a href="" class="pending-btn">{{ $appointment->appointment->status }}</a></button>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
